...
<div class="panel panel-default" style="margin-left: 2%; margin-right: 2%; margin-top: 1%;">
  ...
  <form style="margin-left: 0.2%; margin-right: 2%; margin-top: 1%;" class="form-horizontal col-sm-offset-1" action="${contextPath}/stu/downSign.action" method="GET" id="stuLoginForm">
    <div class="row">
      <div class="col-md-4 form-group">
        <label for="inputStuLoginName" class="col-md-4 control-label">学生卡号</label>
        <div class="col-md-8">
          <input type="text" class="form-control" id="inputStuLoginName" name="stuCardNum" placeholder="101010">
        </div>
      </div>
      <div class="col-md-4 form-group">
